...
const UOMComponent: React.FC<UOMComponentProps> = ({
  ...
  const handleChange = (id: number, field: keyof UomData, value: string) => {
          ...
          <Grid container spacing={2}>
            <Grid size={{ xs: 12, sm: 6, md: 3, lg: 3 }}>
              <Autocomplete
                ...
                onChange={(_, newValue) =>
                  handleChange(row.id, 'uom', newValue?.uomId?.toString() || '')
                }
                size="small"
                renderInput={(params) => (
            ...
            <Grid size={{ xs: 12, sm: 6, md: 3, lg: 3 }}>
              <TextField
                ...
                onChange={(e) =>
                  handleChange(row.id, 'primaryQty', e.target.value)
                }
              />
            </Grid>
            <Grid size={{ xs: 12, sm: 6, md: 3, lg: 3 }}>
          ...
          <Grid container spacing={2}>
            ...
            <Grid size={{ xs: 12, sm: 6, md: 3, lg: 3 }}>
              <TextField
                ...
                value={row.lengthUom}
                onChange={(e) =>
                  handleChange(row.id, 'lengthUom', e.target.value)
                }
              />
            </Grid>
            <Grid size={{ xs: 12, sm: 6, md: 3, lg: 3 }}>
              <TextField
                ...
                value={row.netWeight}
                onChange={(e) =>
                  handleChange(row.id, 'netWeight', e.target.value)
                }
              />
            </Grid>
          </Grid>
          ...
          <Grid container spacing={2}>
            <Grid size={{ xs: 12, sm: 6, md: 3, lg: 3 }}>
              <TextField
                ...
                onChange={(e) =>
                  handleChange(row.id, 'grossWeight', e.target.value)
                }
              />
            </Grid>
            <Grid size={{ xs: 12, sm: 6, md: 3, lg: 3 }}>
              <TextField
                ...
                value={row.weightUom}
                onChange={(e) =>
                  handleChange(row.id, 'weightUom', e.target.value)
                }
              />
            </Grid>
            <Grid size={{ xs: 12, sm: 6, md: 3, lg: 3 }}>
